package com.com.mws.kafkaline.ibgeservice.config;
...
public class KafkaConfig {
    ...
    /*
        quando informado no Bean os topicos para serem monitorados, entao ele cria automaticamente caso
        o respectivo topico nao exista.
